...
class GazeboArmActuatorInterface: public ModelPlugin {
    ...
    std::vector<std::string> link_name_left_={"Link_shoulder_left",
          "fake_link_J1_left","Link_one_left",
          "fake_link_J2_left","Link_two_left",
          "fake_link_J3_left","Link_three_left",
          "Link_hand_left"
          };
    std::vector<std::string> link_name_right_={"Link_shoulder_right",
          "fake_link_J1_right","Link_one_right",
          "fake_link_J2_right","Link_two_right",
          "fake_link_J3_right","Link_three_right",
          "Link_hand_right"
          };

    std::vector<std::string> joint_name_left_={"Joint_shoulder_left",
          "fake_J1_A_left","fake_J1_B_left",
          "fake_J2_A_left","fake_J2_B_left",
          "fake_J3_A_left","fake_J3_B_left",
          "Joint_wrist_left"
          };
    std::vector<std::string> joint_name_right_={"Joint_shoulder_right",
          "fake_J1_A_right","fake_J1_B_right",
          "fake_J2_A_right","fake_J2_B_right",
          "fake_J3_A_right","fake_J3_B_right",
          "Joint_wrist_right"
          };

    Eigen::MatrixXd  Transform_qR2qF;

    Eigen::MatrixXd Transform_qM2qR;

    Eigen::MatrixXd Transform_tauM2tauMR;

    Eigen::MatrixXd MAX_TORQUE;
    ...
    Eigen::VectorXd motor_position_input_left,motor_position_input_right,tau_qF_left,tau_qF_right;
