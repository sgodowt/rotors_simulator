...
namespace rotors_control
{
  ...
  void PositionController::CalculateRPYThrust(mav_msgs::EigenRollPitchYawrateThrust *rpy_thrust) const
  {
    assert(rpy_thrust);
    ...
    if (!controller_active_)
    {
      ...
      rpy_thrust->thrust = Eigen::Vector3d::Zero();
      return;
    }
